...
public class JGitTest {
    ...
    public void test() throws Exception {
        // 这部分替换为你的
        String repoURL = "https://gitcode.com/qq_59469663/Project1";
        String username = "qq_59469663";
        String password = "TtuyW-jTyXRicL27QsexzDrr";
    ...
    public void test_file() throws IOException {
        Files.walkFileTree(Paths.get("./cloned-repo"), new SimpleFileVisitor<>() {
            ...
            public FileVisitResult visitFile(Path file, BasicFileAttributes attrs) throws IOException {
                ...
                // 修复点1：过滤 .git 目录下的文件（这类文件多为配置/空文件，无需解析）
